...
def test_end_at():
    response = client.get("/historical?end_at=2010-01-05")
    assert response.status_code == 200
    assert response.json() == {
                               "rates":{
                                  "2010-01-04": {
...
def test_end_start_at():
    response = client.get("http://127.0.0.1:8000/historical?start_at=2010-01-04&end_at=2010-01-04")
    assert response.status_code == 200
    assert response.json() =={
                                "rates":{
                                    "2010-01-04":{
